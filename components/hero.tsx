      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Gilang Rizki <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Ramadhan</span>
            </motion.h1>
            ...
            >
              Fullstack Developer | AI & IoT Specialist | Backend Engineer
            </motion.p>
            ...
            >
              Mahasiswa D4 Teknologi Rekayasa Internet dengan passion pada software engineering, backend development, dan integrasi AI dalam sistem berbasis web dan IoT. Juara 2 AITECH 2024 dengan 3+ projects inovasi teknologi.
            </motion.p>
